...
class ClockCore extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { current_time: 0, power_on: 1 });
	}
}
...
class StopwatchCore extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { elapsed_time: 0, power_on: 1 });
	}
}

export { ClockCore, StopwatchCore, TimerCore };
